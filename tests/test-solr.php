...
class SolrTest extends WP_UnitTestCase {
	...
	public function test_index_post() {
		$this->factory->post->create( array( 'post_title'   => 'Test Post Title',
	...
	public function test_index_page() {
		$this->factory->post->create( array( 'post_title'   => 'Test Page Title',
	...
	public function test_update_post() {
		$original_post_id = $this->factory->post->create( array( 'post_title'   => 'Test Post Update Title',
		                                                         'post_content' => 'Test Post Update Content'
		) );
	...
	public function test_update_page() {
		$original_page_id = $this->factory->post->create( array( 'post_title'   => 'Test Page Update Title',
		                                                         'post_content' => 'Test Page Update Content',
		                                                         'post_type'    => 'page'
		) );
		...
		wp_update_post( array( 'ID'           => $original_page_id,
		                       'post_content' => 'Page Content Has Been Entirely Changed'
		) );
	...
	public function test_delete_post() {
		$postId = $this->factory->post->create( [ 'post_title'   => 'Test Post Title',
		                                          'post_content' => 'Test Post Content'
		] );
	...
	public function test_priority_given_to_post_with_more_keyword_matches() {
		...
		$this->factory->post->create( array( 'post_title'   => 'Test Post Title 2',
		                                     'post_content' => 'Test Post Content 2',
		                                     'post_type'    => 'post'
		) );
		$this->factory->post->create( array( 'post_title'   => 'Another Test Post Title',
		                                     'post_content' => 'Another Test Post Content',
		                                     'post_type'    => 'post'
		) );
